...
class TestOCBScalingMethods(unittest.TestCase):
    ...
    def test_init(self):
        ...
        """
        self.assertAlmostEquals(self.vdata.aacgm_mag, 100.036243432)
    ...
    def test_calc_vec_pole_angle(self):
        ...
        self.assertAlmostEquals(self.vdata.pole_angle, 7.52899382202)
        ...
        self.vdata.calc_vec_pole_angle()
        self.assertEquals(self.vdata.pole_angle, 0.0)
        ...
        self.vdata.calc_vec_pole_angle()
        self.assertEquals(self.vdata.pole_angle, 180.0)
        ...
        self.vdata.calc_vec_pole_angle()
        self.assertEquals(self.vdata.pole_angle,
                          self.vdata.ocb_aacgm_mlt * 15.0)

        # When the MLT is 06:00 the calculated angle equals 90 - the OCB MLT
        self.vdata.aacgm_mlt = 6.0
        self.vdata.calc_vec_pole_angle()
        self.assertEquals(self.vdata.pole_angle + self.vdata.ocb_aacgm_mlt
                          * 15.0, 90.0)
    ...
    def test_define_quadrants(self):
        ...
        self.assertEquals(self.vdata.ocb_quad, 1)
        self.assertEquals(self.vdata.vec_quad, 1)
    ...
    def test_scale_vec(self):
        ...
        self.assertAlmostEquals(self.vdata.ocb_n, 60.9028461225)
        self.assertAlmostEquals(self.vdata.ocb_e, 79.2028619065)
        
        # Test to see that the magnitudes and z-components are the same
        self.assertEquals(self.vdata.aacgm_mag, self.vdata.ocb_mag)
        self.assertEquals(self.vdata.ocb_z, self.vdata.aacgm_z)
    ...
    def test_set_ocb(self):
        ...
        self.assertAlmostEquals(self.vdata.ocb_mag, 80.3516453163)
