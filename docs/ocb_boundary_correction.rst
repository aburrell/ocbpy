...
These corrections are applied using the *rfunc* and *rfunc_kwargs* keyword
arguments in **ocbpy.OCBoundary** object (described in `module <OCBoundary_>`_).
Several correction functions are provided as a part of **ocbpy.ocb_correction**
`module <OCB Correction_>`_.
